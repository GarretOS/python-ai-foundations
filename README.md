...
- `exercises/` — practice scripts by section
- `projects/` — small projects that combine concepts
- `scripts/` — helper scripts
- `data/` — small sample datasets (no large files)

## Progress

| Section | Topic | Notes | Exercises |
|---|---|---|---|
| 00 | Setup | done | n/a |
